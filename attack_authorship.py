"""Authorship attack — mirrors notebook auth suite (comment strip [+ normalize]).

Basic: paper-faithful comment removal on ALL samples.
Enhanced: comment removal + naming/layout normalization (machine-only).

Usage:
  python attack_authorship.py --language python --mode basic
  python attack_authorship.py --language java --mode enhanced
"""
import argparse
...
def main():
    ...
    run_single_attack(language=args.language, attack_type="auth", mode=args.mode,
